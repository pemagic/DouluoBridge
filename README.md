...
> **Cross-Platform Edition** v1.8.31 — 中国水墨风武侠横版动作游戏 (iOS & Android)
...
### 💥 v1.8.31 最新特性与变更
- fix(build): 彻底修复 iOS 无法跨版本同步展示迭代版本号的遗留大坑，将 Info.plist 中的 CFBundleShortVersionString 和 CFBundleVersion 由写死的 1.8.23 迁移绑定为统一的环境变量  和
### 🏯 十关境界
