...
class PlayerNode: SKNode {
    ...
    func rebuildVisual() {
        ...
        if lvl >= 10 { cloakColor = PlayerNode.neonColors[0].darkened(0.42) }
        else if lvl >= 7 { cloakColor = UIColor(red: 0.30, green: 0.11, blue: 0.58, alpha: 1).darkened(0.42) } // #4c1d95
        else if lvl >= 4 { cloakColor = UIColor(red: 0.19, green: 0.18, blue: 0.51, alpha: 1).darkened(0.42) } // #312e81
        else { cloakColor = UIColor(red: 0.13, green: 0.13, blue: 0.13, alpha: 1).darkened(0.42) } // #222
        ...
        torso.fillColor = (lvl >= 7 ? .white : UIColor(white: 0.93, alpha: 1)).darkened(0.42)
        ...
        let hatColor: UIColor = lvl >= 7
            ? UIColor(red: 0.98, green: 0.75, blue: 0.14, alpha: 1).darkened(0.42)
            : UIColor(red: 0.27, green: 0.27, blue: 0.27, alpha: 1).darkened(0.42)
        ...
        hat.strokeColor = lvl >= 10 ? .white.darkened(0.42) : .clear
        ...
        if lvl >= 10 { swordColor = PlayerNode.neonColors[0].darkened(0.42) }
        else if lvl >= 7 { swordColor = UIColor(red: 0.98, green: 0.75, blue: 0.14, alpha: 1).darkened(0.42) }
        else { swordColor = .white.darkened(0.42) }
        ...
        if lvl >= 10 {
            ...
            for i in 0..<8 {
                ...
                swordOrbit.fillColor = PlayerNode.neonColors[i % PlayerNode.neonColors.count].darkened(0.42)
